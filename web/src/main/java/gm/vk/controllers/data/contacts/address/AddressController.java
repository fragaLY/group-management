...
import gm.vk.util.data.contacts.address.AddressLinkBuilder;
...
public class AddressController {
  ...
  @Autowired private AddressService addressService;
    ...
    public ResponseEntity<List<AddressDto>> getAddresses() {
        final List<AddressDto> addresses = addressService.findAll();

        final AddressLinkBuilder linkBuilder = new AddressLinkBuilder();
        addresses.forEach(linkBuilder);

        return new ResponseEntity<>(addresses, new HttpHeaders(), HttpStatus.FOUND);
  }
