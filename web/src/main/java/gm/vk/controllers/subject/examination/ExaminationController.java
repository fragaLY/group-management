...
import gm.vk.util.subject.examination.ExaminationLinkBuilder;
...
public class ExaminationController {
  ...
  public ResponseEntity<List<ExaminationDto>> getExaminations() {
    ...
    final ExaminationLinkBuilder linkBuilder = new ExaminationLinkBuilder();
    examinations.forEach(linkBuilder);
  ...
  public ResponseEntity<ExaminationDto> getExamination(
    ...
    final ExaminationLinkBuilder linkBuilder = new ExaminationLinkBuilder();
    linkBuilder.accept(examination);
