...
@Component("personalDataConverter") public class PersonalDataConverter
    implements Function<PersonalData, PersonalDataDto> {
   ...
   */
  @Override public PersonalDataDto apply(@NotNull final PersonalData personalData) {
