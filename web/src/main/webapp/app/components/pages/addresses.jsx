...
const AddressesPage = withRouter(React.createClass({
        ...
        return (
            <div>
                ...
                <div style={{paddingLeft: '65px'}} className="padding-top-10">
                    <Tags data={tags}/>
                    <div className="padding-top-10 share-block"><a href="#">{t('Share')}</a>&nbsp;&nbsp;<a
                        href="#">{t('Report')}</a></div>
                </div>
                ...
                <form className={auth.loggedIn() ? '' : 'hide'} name="answers" action="answers" method="post"
                      onSubmit={this.handleSubmit}>
                    <div className="message color-red"></div>
                    {t('Message')} <textarea onChange={this.onChangeAnswer} ref="message" name="message"
