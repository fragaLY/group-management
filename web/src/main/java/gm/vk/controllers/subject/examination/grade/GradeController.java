...
import gm.vk.util.subject.examination.grade.GradeLinkBuilder;
...
public class GradeController {
  ...
  public ResponseEntity<List<GradeDto>> getGrades() {
    ...
    final GradeLinkBuilder linkBuilder = new GradeLinkBuilder();
    grades.forEach(linkBuilder);
